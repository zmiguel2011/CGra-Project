...
export class MyScene extends CGFscene {
    ...
    initMaterials() {
        ...
        // Wood ex4 (following example of red diffuse, no ambient and no specular)
        ...
        // Labels and ID's for object selection on MyInterface
        this.materialIDs = {'Red Ambient': 0, 'Red Diffuse': 1, 'Red Specular': 2, 'Custom Wood': 3, 'Custom': 4 };
    }
    display() {
        ...
        // Rotates the Prism and Cylinder so they are parellel with the y axis
