...
export class MyTangram extends CGFobject {
    ...
    createMaterials() {
        ...
        display() {
            ...
            // Draw diamond
            this.tangramMaterial.apply();  // custom texture for MyDiamond 
            ...
            // Draw first triangle
            this.trianglebig.toggleTexCoords();
            this.tangramMaterial.apply();  // blue
            ...
            this.trianglebig.toggleTexCoords();
            this.tangramMaterial.apply(); // orange 
            this.trianglebig.display();
            this.scene.popMatrix();
            ...
            this.scene.rotate(-Math.PI / 4, 0, 0, 1);
            // Draw parallelogram
            this.tangramMaterial.apply(); // yellow 
            ...
            this.tangramMaterial.apply(); // pink 
            ...
            this.scene.rotate(-Math.PI / 4, 0, 0, 1);
            // Draw first triangle
            this.trianglesmall.setTexCoords(2);
            this.tangramMaterial.apply(); // red
            ...
            this.tangramMaterial.apply(); // purple 
            this.trianglesmall.display();
            this.scene.popMatrix();
